(function () {
  ...
  function butterflySVG(color) {
    return `<svg viewBox="0 0 40 30" width="100%">
      <g class="wing wing--l"><path d="M20 15 C6 -8 -12 2 3 15 C-12 27 6 37 20 15 Z" fill="${color}" opacity=".92" stroke="rgba(30,22,42,1)" stroke-width="1"/></g>
      <g class="wing wing--r"><path d="M20 15 C34 -8 52 2 37 15 C52 27 34 37 20 15 Z" fill="${color}" opacity=".92" stroke="rgba(30,22,42,1)" stroke-width="1"/></g>
